      ...
      >
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-1.5">
            <label className="block text-[12px] font-medium text-text-muted">
              To confirm deletion, type <code className="rounded-xs border border-border-subtle bg-bg-primary px-1.5 py-0.5 font-mono text-[11px] font-bold text-text-primary">DELETE</code> below:
            </label>
            <input
              type="text"
              value={inputText}
              ...
              disabled={isDeleting}
              className="w-full rounded-sm border border-border-subtle bg-bg-card px-3.5 py-2 font-mono text-[13px] text-text-primary placeholder:text-text-muted outline-none transition-all focus:border-border-hover focus:shadow-focus"
              autoFocus
            />
          </div>
        ...
        <div className="flex items-center justify-end gap-2 pt-1">
          <button
            ...
            onClick={onClose}
            disabled={isDeleting}
            className="rounded-xs border border-border-subtle bg-transparent px-4 py-2 text-xs font-mono uppercase tracking-wider font-medium text-text-primary transition-all duration-200 hover:bg-bg-primary active:scale-95 cursor-pointer disabled:opacity-50"
          >
            Cancel
          </button>
          ...
          <button
            ...
            className={`flex items-center gap-2 rounded-xs px-4 py-2 text-xs font-mono uppercase tracking-wider font-semibold transition-all ${
