                ...
                <div key={key} className="rounded-lg border border-border-subtle bg-bg-primary/30 p-4">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <button
                      ...
                      className="rounded-md border border-text-primary bg-text-primary px-3 py-1.5 text-xs font-medium text-bg-primary transition-all hover:opacity-90 disabled:opacity-50"
                    >
