...
const navLinkClass = (active: boolean) =>
  `mb-1 flex w-full text-left cursor-pointer items-center gap-3 rounded-sm px-3.5 py-2 text-[13px] font-medium no-underline transition-all duration-150 ${
    active
      ? "bg-bg-primary font-semibold text-accent-terracotta border-l-2 border-accent-terracotta shadow-xs"
      : "bg-transparent border-l-2 border-transparent text-text-secondary hover:bg-bg-primary hover:text-text-primary"
  }`;
      ...
      <div className="flex flex-1 flex-col gap-1 overflow-y-auto">
        <nav aria-label="Main Navigation" className="flex flex-col gap-1">
          <button
            ...
            className={navLinkClass(activeTab === "expenses")}
          >
            <svg aria-hidden="true" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="5" width="20" height="14" rx="2"/><line x1="2" y1="10" x2="22" y2="10"/></svg>
        ...
        <button
          ...
          className={navLinkClass(activeTab === "financial")}
        >
          <svg aria-hidden="true" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg>
        ...
        {showInvestmentsTab && (
          <button
            ...
            className={navLinkClass(activeTab === "investments")}
          >
            <svg aria-hidden="true" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
        ...
        <button
          ...
          className={navLinkClass(activeTab === "reports")}
        >
          <svg aria-hidden="true" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
          <span>Reports</span>
        </button>
        <button
          type="button"
          ...
          className={navLinkClass(activeTab === "agent")}
        >
          <svg aria-hidden="true" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 8V4H8"/><rect x="4" y="8" width="16" height="12" rx="2"/><path d="M2 14h2M20 14h2M15 13v2M9 13v2"/></svg>
          <span>AI Agent</span>
          {!isProUser && (
            <span className="ml-auto inline-flex shrink-0 items-center rounded-sm border border-border-subtle bg-bg-secondary px-1.5 py-[0.5px] font-mono text-[8.5px] font-semibold text-accent-yellow tracking-wider uppercase">
              PRO
        ...
        {user && user.email === (process.env.NEXT_PUBLIC_ADMIN_EMAIL || "adiad.dev@gmail.com") && (
          <button
            ...
            className={navLinkClass(activeTab === "admin")}
          >
            <svg aria-hidden="true" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="11" width="18" height="11" rx="2" ry="2" /><path d="M7 11V7a5 5 0 0 1 10 0v4" /></svg>
        ...
        <div className="mt-5 flex flex-col gap-1.5 border-t border-border-subtle pt-3.5">
          ...
          {anilistUser ? (
            ...
            <button type="button" onClick={connectAnilist} className={navLinkClass(false)}>
          ...
          {traktUser ? (
            ...
            <button type="button" onClick={connectTrakt} className={navLinkClass(false)}>
          ...
          {letterboxdUsername ? (
            ...
            <button type="button" onClick={connectLetterboxd} className={navLinkClass(false)}>
